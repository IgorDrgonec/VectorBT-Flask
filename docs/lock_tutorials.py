...
locked_tutorials = {
    ...
    Path("tutorials/patterns-and-projections/patterns-locked"): "Patterns and projections - Patterns",
    Path("tutorials/patterns-and-projections/projections-locked"): "Patterns and projections - Projections",
}
