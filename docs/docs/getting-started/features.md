...
On top of the [features](https://vectorbt.dev/getting-started/features/) offered by the vanilla version of vectorbt, vectorbt PRO implements the following enhancements:
