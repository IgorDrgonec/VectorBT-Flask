...
entries generated previously. We'll also run the method in the "Chain Exits" mode to force vectorbt 
...
2. A nice property of the "Chain Exits" mode is that each exit is guaranteed to come right after its entry - 
