...
logs_field_config = ReadonlyConfig(
    dict(
        ...
        settings=dict(
            ...
            exec_state_cash=dict(title="[ST0] Cash"),
            exec_state_position=dict(title="[ST0] Position"),
            exec_state_debt=dict(title="[ST0] Debt"),
            exec_state_locked_cash=dict(title="[ST0] Locked Cash"),
            exec_state_shorted_cash=dict(title="[ST0] Shorted Cash"),
            exec_state_free_cash=dict(title="[ST0] Free Cash"),
            exec_state_val_price=dict(title="[ST0] Valuation Price"),
            exec_state_value=dict(title="[ST0] Value"),
            ...
            new_exec_state_cash=dict(title="[ST1] Cash"),
            new_exec_state_position=dict(title="[ST1] Position"),
            new_exec_state_debt=dict(title="[ST1] Debt"),
            new_exec_state_locked_cash=dict(title="[ST1] Locked Cash"),
            new_exec_state_shorted_cash=dict(title="[ST1] Shorted Cash"),
            new_exec_state_free_cash=dict(title="[ST1] Free Cash"),
            new_exec_state_val_price=dict(title="[ST1] Valuation Price"),
            new_exec_state_value=dict(title="[ST1] Value"),
            ...
            order_id=dict(title="[RES] Order Id", mapping="ids"),
        ),
    )
)
"""_"""
