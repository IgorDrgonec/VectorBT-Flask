...
`vectorbtpro._settings.settings`, or by providing `column_names` directly to the accessor.
...
from vectorbtpro.root_accessors import register_df_vbt_accessor
...
class OHLCVDFAccessor(GenericDFAccessor):  # pragma: no cover
    ...
    def stats_defaults(self) -> tp.Kwargs:
        ...
        `ohlcv.stats` from `vectorbtpro._settings.settings`."""
        from vectorbtpro._settings import settings
    ...
    def plots_defaults(self) -> tp.Kwargs:
        ...
        `ohlcv.plots` from `vectorbtpro._settings.settings`."""
        from vectorbtpro._settings import settings
