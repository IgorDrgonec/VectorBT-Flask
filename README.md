...
vectorbt PRO (Beta) is the ultimate engine for backtesting, algorithmic trading, and research. It is a high-performance superset of the [vectorbt](https://github.com/polakowo/vectorbt) library, one of the world's most innovative open-source backtesting engines. vectorbt PRO extends the standard vectorbt library with new impressive features and useful enhancements.
